...
def main():
    ...
    datatrain = pd.read_excel("Final_RedSet-20DataTrain_Preprocessed.xlsx", names=["labels", "user1", "user2", "Text1", "Text2"])
    ...
    datatest = pd.read_excel("Final_RedSet-20DataTest_Preprocessed.xlsx", names=["labels", "user1", "user2", "Text1", "Text2"])
