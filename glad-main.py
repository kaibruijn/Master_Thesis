...
from sklearn import svm, preprocessing, naive_bayes, neighbors, ensemble, metrics, linear_model
...
def __available_classifiers():
    ...
    available_clfs["raf"] = Classifier("raf", "Random Forest",
                                       ...
                                       True, True, False)
    available_clfs["lr"] = Classifier("lr", "Linear Regression", linear_model.LinearRegression(), False, False, True)
